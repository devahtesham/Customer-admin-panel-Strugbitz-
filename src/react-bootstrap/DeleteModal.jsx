                ...
                <Row className='justify-content-center my-5 mt-3'>
                    <Col xs={11}>
                        ...
                        <div className="edit-del-buttons d-flex gap-3 align-items-center">
                            <button className='custom-btn custom-btn-sm btn-sm-3 w-50'>Cancel</button>
                            <button className='custom-btn custom-btn-sm bg-danger w-50 text-white'>Delete</button>
                        </div>
                    </Col>
                </Row>
            </Modal>
